          ...
          <section className="container mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 lg:items-start">
              ...
              <div className="mt-10 lg:mt-2 lg:ml-72 lg:mb-28 text-center lg:text-left">
                ...
                <br />
                <div className="mb-10">
                  <NavLink to="/register"><button className="font-bold text-xl text-white bg-[#fc621c] py-2 px-6 lg:px-10 rounded-full hover:bg-orange-400 hover:text-black">Register</button></NavLink>
                </div>
              </div>
            </div>
