        ...
        <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20 px-10 py-10 lg:py-20 gap-6">
          <div>
            ...
            <div className="flex flex-col items-center justify-center mt-10 rounded-full">
              <img
                src="https://i.ibb.co/sPy6Wc9/people3.png"
                alt="profile picture"
                className="w-12 h-12"
              />
              <p className="text-base font-semibold leading-4 my-2 text-[#fc621c]">
                John Deo
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="flex flex-col items-center justify-center mt-10">
              <img
                src="https://i.ibb.co/1JZWRb8/people2.png"
                alt="profile picture"
                className="w-12 h-12"
              />
              <p className="text-base font-semibold leading-4 my-2 text-[#fc621c]">
          ...
          <div>
            <div
              className="group w-full bg-gre relative flex flex-col items-center hover:bg-gray-700 cursor-pointer shadow-md md:p-12 p-6"
              data-aos="zoom-out"
              data-aos-duration="1500"
            >
              <div className="text-gray-600 group-hover:text-white flex flex-col items-center">
            ...
            <div className="flex flex-col items-center justify-center mt-10">
              <img
                src="https://i.ibb.co/T1rxksr/people1.png"
                alt="profile picture"
                className="w-12 h-12"
              />
              <p className="text-base font-semibold leading-4 my-2 text-[#fc621c]">
